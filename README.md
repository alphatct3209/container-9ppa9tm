...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-9ppa9tm.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-9ppa9tm.containers.anotherwebservice.com/
...
```
git clone git@github.com:alphatct3209/container-9ppa9tm.git
cd container-9ppa9tm
```
...
```
docker attach container-9ppa9tm
```
